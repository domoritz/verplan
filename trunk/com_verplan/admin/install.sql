...
('12' , 'debug', 'false', 'false','Debug Mode für JS'),
('13' , 'class_col', '(Klasse(n))', '(Klasse(n))','Spaltenname der Klassenspalte'),
('14' , 'class_name', '(Klasse(n))', '(Klasse(n))','Variablenname der Klassenspalte in JSON'),
('15' , 'version', '', '','nicht verändern');