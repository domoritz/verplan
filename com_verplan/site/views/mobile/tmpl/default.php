...
<div id="header_verplan">
	<img alt="logo vertretungsplan" style="width: 152" src="<?php echo $this->baseurl;?>/components/com_verplan/includes/images/logo/logo_final_32.png" id="logo_verplan"/>
	<p>
...
<?php //ende access
	...
	echo '<p>Zugang verweigert! Bitte logge dich ein. </p>zum <a href="'.JURI::base().'/index.php?option='.$logincomponent.'&view=login&return=aW5kZXgucGhwP29wdGlvbj1jb21fdmVycGxhbiZ2aWV3PW1vYmlsZQ==">Login</a>';
	echo '</div></div>';
}
?>
