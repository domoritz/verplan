...
('9' , 'upload_dir_comp', '/components/com_verplan/uploads/', '/components/com_verplan/uploads/','Verzeichnis für den Upload (in Administrator)'),
('10' , 'upload_dir', '/components/com_verplan/uploads/', '/components/com_verplan/uploads/','Verzeichnis der Vertretungsplandateien (in Administrator)'),
('11' , 'keep_files', 'false', 'false','Dateien nach dem Parsen behalten'),
('12' , 'number_show', '5', '5','Anzahl der anzuzeigenden Daten. Daten in der Zukunft werden immer zusätztlich angezeigt.'),
('13' , 'load_jquery_frontend', 'true', 'true','jQuery laden (Frontend)'),
('14' , 'load_jquery_backend', 'true', 'true','jQuery laden (Backend)'),
('15' , 'load_jqueryui_frontend', 'true', 'true','jQueryUI laden (Frontend)'),
('16' , 'load_jqueryui_backend', 'true', 'true','jQueryUI laden (Backend)'),
...
('19' , 'notify', 'pnotify', 'pnotify', 'Notificationsystem: own, pnotify, both oder none'),
('20' , 'head_text', 'Das hier ist die Betaversion der neuen Vertretungsplankomponente. Weitere Informationen: <a href="http://verplan.googlecode.com" target="_blank" id="link_project" title="Projektseite">verplan.googlecode.com</a>. Bitte sende dein <a id="feedy" title="Feedbackbogen" rel="prettyPhoto[iframes]" href="http://spreadsheets.google.com/viewform?formkey=dGdDanZxa2k4RHhKbHJaS1RxT0Q2eWc6MA&iframe=true&width=90%&height=100%">Feedback</a>!', '', 'Text, der im Frontend erscheint'),
('21' , 'message_title', 'Betaversion', '', 'Überschrift der Benachrichtigung im Frontend. Nur mit pnotify (leer lassen für keine)'),
('22' , 'message', 'Hey, du benutzt eine <strong>Betaversion</strong>. Das Programm steht kurz vor der Veröffentlichung. Bitte melde Fehler und gib dein <a href="http://spreadsheets.google.com/viewform?formkey=dGdDanZxa2k4RHhKbHJaS1RxT0Q2eWc6MA"><strong>Feedback</strong></a> ab. Jedes einzelne ist für mich sehr wichtig.<br> Vielen Dank und viel Spaß', '', 'Benachrichtigung');
