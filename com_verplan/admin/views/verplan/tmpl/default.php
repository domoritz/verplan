...
<div id="header_verplan" class="ui-helper-clearfix panel">
	<a href="<?php echo JURI::base() ?>index.php?option=com_verplan"><img alt="logo vertretungsplan" style="width: 152" src="<?php echo JURI::base();?>../components/com_verplan/includes/images/logo/logo_final_32.png" id="logo_verplan"/></a>
